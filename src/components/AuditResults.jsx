    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-emerald-950 py-12 text-white">
      <div className="mx-auto max-w-6xl px-6">
        <div className="mb-8 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            <p className="text-sm font-semibold uppercase tracking-[0.2em] text-emerald-300/80">Day 3 Output</p>
        ...
        <section className="grid gap-4 md:grid-cols-4">
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-5">
            ...
            <p className="mt-3 text-lg font-semibold">
              {Object.keys(auditData.tools).length} tools
            </p>
            ...
            <div className="mt-4 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
              <div>
                <h2 className="text-2xl font-semibold">
                  ...
                  {highestSavingsTool.monthlySavings > 0 ? ` can save ${formatCurrency(highestSavingsTool.monthlySavings)}/mo` : ' looks healthy'}
                </h2>
